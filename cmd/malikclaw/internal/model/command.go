...
Examples:
  malikclaw model                    # Show current default model
  malikclaw model gpt-5.2           # Set gpt-5.2 as default
  malikclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  malikclaw model local-model       # Set local VLLM server as default
