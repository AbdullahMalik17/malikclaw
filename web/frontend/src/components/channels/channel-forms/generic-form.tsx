...
export function GenericForm({
  ...
  const buildHint = (key: string): string => {
    const descriptions: Record<string, string> = {
      ...
      service_account_file: t("channels.form.desc.serviceAccountFile"),
      verification_token: t("channels.form.desc.verificationToken"),
      bot_user: t("channels.form.desc.botUser"),
