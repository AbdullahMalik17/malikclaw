...
func TestHandleListSkills(t *testing.T) {
	...
	oldBuiltin := os.Getenv("MALIKCLAW_BUILTIN_SKILLS")
	if err := os.Setenv("MALIKCLAW_BUILTIN_SKILLS", builtinRoot); err != nil {
		t.Fatalf("Setenv(MALIKCLAW_BUILTIN_SKILLS) error = %v", err)
	}
	defer func() {
		if oldBuiltin == "" {
			_ = os.Unsetenv("MALIKCLAW_BUILTIN_SKILLS")
		} else {
			_ = os.Setenv("MALIKCLAW_BUILTIN_SKILLS", oldBuiltin)
		}
	}()
