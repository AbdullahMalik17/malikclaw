...
CONTAINER_NAME="malikclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.malikclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run malikclaw:"
echo "  cd packages/malikclaw && go run ./cmd/malikclaw gateway"
echo ""
